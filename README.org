...
#+BEGIN_SRC emacs-lisp
  ...
  ;; orgmode leader map
  (evil-leader/set-key-for-mode 'org-mode "e" 'org-set-effort)
...
#+RESULTS:
| thesis  | \documentclass[12pt]{uthesis-v12} | (\chapter{%s} . \chapter*{%s}) | (\section{%s} . \section*{%s})       | (\subsection{%s} . \subsection*{%s})       |                                      |                                            |
